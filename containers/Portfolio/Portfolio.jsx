...
const Portfolio = () => {
  return (
    <div className="flex flex-col mb-32 text-center gap-10" id="portfolio">
      ...
      <Title
        title={"portfolio"}
        phrase={"An eye for detail makes our work beautiful"}
      />

      {/* portofolio cases */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 justify-center col-auto">
        <Work
          src={"/portfolio01.jpeg"}
          alt={"portfolio"}
          cat={"graphic design"}
        />
        <Work
          src={"/portfolio02.jpeg"}
          alt={"portfolio"}
          cat={"print design"}
        />
      ...
      {/* portoflio contact */}
      <div>
        <p className="text-[1.4rem] italic mb-10">Have a Project in Mind?</p>
