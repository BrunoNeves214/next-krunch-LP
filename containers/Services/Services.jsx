...
const Services = () => {
  return (
    <div id="services" className="flex flex-col items-center gap-7 px-7 mb-32">
      {/* title */}
      <Title title={'service'} phrase={'Scope of our featured premium services'} />
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 max-w-[1280px]'>
        ...
        title={'web design'} 
        phrase={'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim eros elementum tristique. Duis cursus, viverra ornare, eros dolor interdum nulla, commodo diam libero vitae.'} />
        <Service 
