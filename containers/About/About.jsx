...
const About = () => {
  return (
    <div id="about" className='flex flex-col items-center mb-32 mx-10 gap-5'>
      {/* title */}
      <Title title={'about us'} phrase={'Setibulum rutrum quam vitae fringilla tincidunt'}/>
      ...
      <div className='flex flex-col justify-center items-center lg:flex-row gap-10 max-w-[1280px]'>
        ...
        <div className='flex-1 flex flex-col gap-5 lg:gap-7'>
          ...
          <p>Excepteur sint occaecat cupidatat none proident, sunt in culpa qui officia deserunt mollit anim id est laborum voluptate dolor.</p>
        </div>
